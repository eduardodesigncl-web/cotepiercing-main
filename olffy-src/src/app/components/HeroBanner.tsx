...
export function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{ background: s.bg, minHeight: 560, borderRadius: 0, transition: "background 0.5s ease" }}
    >
      {/* Slide content */}
      <div
      ...
      >
        {/* ── Background image (full-bleed for slide 1, right-half for others) ── */}
        {s.img && (s as any).fullBleed ? (
          <>
            ...
            <div
              ...
              style={{ background: "linear-gradient(to right, rgba(242,224,204,0.92) 0%, rgba(242,224,204,0.75) 50%, rgba(242,224,204,0.1) 100%)" }}
            />
          </>
        ) : s.img ? (
          ...
          <div
            ...
            style={{ fontFamily: piepie, fontSize: 120, color: "#fff" }}
          >
            olffy
          </div>
        )}
        ...
        <div className="relative flex flex-col justify-center px-16 py-16 h-full max-w-[580px]" style={{ minHeight: 560 }}>
          ...
          {/* Title: Ivy Presto serif line */}
          <h1
            className="leading-[1.05] mb-1"
            style={{
              fontFamily: ivy,
              fontWeight: 300,
              fontSize: (s as any).fullBleed ? "52.695px" : "clamp(42px, 4.5vw, 72px)",
              fontStyle: "italic",
              color: textColor,
            }}
          >
          ...
          {/* Title: PiepieW01 display line */}
          <div className="mb-6" style={{ width: 280, height: 86, position: "relative", ["--logo-color" as any]: current === 1 ? "#FAB405" : undefined }}>
            <OlffyLogoNav />
          </div>
          ...
          {/* CTA */}
          <button
            className="self-start rounded-full transition-transform hover:scale-105 active:scale-95"
            style={{
              fontFamily: poppins,
              fontWeight: 500,
              fontSize: 15,
              ...
              height: (s as any).fullBleed ? 50.5 : undefined,
              width: (s as any).fullBleed ? 196 : undefined,
              padding: (s as any).fullBleed ? undefined : "14px 28px",
            }}
          >
            {s.cta} →
          </button>
          ...
          <button
            ...
            style={{
              ...
              background: i === current
                ? s.dark ? C.orange : "#fff"
                : s.dark ? "rgba(0,0,0,0.25)" : "rgba(255,255,255,0.35)",
            }}
          />
        ))}
      </div>
